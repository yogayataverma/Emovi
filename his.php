...
<?php
    ...
    echo "<p style='margin-top:100px;margin-left:600px;'>Percentage Of Happiness Of A Particular Student</p>";
?>


<div id="chart_div" style="width: 500px; height: 500px; margin-left:500px;"></div>
